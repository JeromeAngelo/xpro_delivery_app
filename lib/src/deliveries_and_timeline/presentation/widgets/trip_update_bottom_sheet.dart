                    ...
                    const SizedBox(height: 24),
                      ...
                      listener: (context, state) {
                        if (state is TripUpdateCreated) {
                          debugPrint('🔄 Processing trip update creation success');
                          
                          // Navigate immediately after local creation
                          debugPrint('🚀 Navigating to target screen while background sync continues');
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('Failed to create trip update: ${state.message}'),
