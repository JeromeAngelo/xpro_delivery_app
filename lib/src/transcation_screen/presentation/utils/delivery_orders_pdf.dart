...
class DeliveryOrdersPDF {
  static Future<Uint8List> generatePDF({
    ...
    debugPrint('🚀 Starting PDF generation process for delivery: ${deliveryData.id}');
    ...
    try {
      ...
      if (invoice == null) {
        throw Exception('Invoice data is required for PDF generation');
      }
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.SizedBox(height: 8),
                  pw.Text(
                    'Invoice Reference: ${invoice.refId ?? 'N/A'}',
                    style: contentStyle,
                  ),
                  pw.Text(
                  ...
                  if (invoice.documentDate != null)
                    pw.Text(
                      'Document Date: ${_formatDate(invoice.documentDate!)}',
                      style: contentStyle,
                    ),
                  ...
                  if (invoice.volume != null)
                    pw.Text(
                      'Volume: ${invoice.volume!.toStringAsFixed(2)}',
                      style: contentStyle,
                    ),
                  if (invoice.weight != null)
                    pw.Text(
                      'Weight: ${invoice.weight!.toStringAsFixed(2)} kg',
                      style: contentStyle,
                    ),
                ],
              ),
            ...
            if (invoiceItems.isNotEmpty) ...[
              ...
              pw.TableHelper.fromTextArray(
                ...
                data: invoiceItems.map((item) => [
                  ...
                  item.uomPrice != null ? '₱${item.uomPrice!.toStringAsFixed(2)}' : '₱0.00',
                ...
                children: [
                  ...
                  pw.Row(
                    ...
                    children: [
                      ...
                      pw.Text('${invoiceItems.length}', style: contentStyle),
                    ],
                  ),
                  if (invoice.totalAmount != null)
                    pw.Row(
                  ...
                  if (deliveryData.paymentSelection != null)
                    pw.Row(
                      ...
                      children: [
                        ...
                        pw.Text(
                          deliveryData.paymentSelection.toString().split('.').last,
                          style: contentStyle,
                        ),
                      ],
                    ),
              ...
              children: [
                ...
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.SizedBox(height: 5),
                    pw.Container(width: 150, child: pw.Divider()),
                    pw.Text('Delivery Personnel Signature', style: contentStyle),
                    pw.Text('Date: _______________', style: contentStyle),
                  ],
                ),
              ],
  ...
  static Future<Uint8List> generateBatchDeliveryPDF({
    ...
    debugPrint('🚀 Starting batch PDF generation for ${deliveries.length} deliveries');
    final pdf = pw.Document();
    ...
    try {
      ...
      for (int i = 0; i < deliveries.length; i++) {
        ...
        debugPrint('📝 Processing delivery ${i + 1}/${deliveries.length}: ${delivery.id}');
