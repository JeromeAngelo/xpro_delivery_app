...
class FinalUndeliveredSpecScreen extends StatefulWidget {
  ...
  const FinalUndeliveredSpecScreen({
    super.key,
    required this.cancelledInvoiceId,
  });

  @override
  State<FinalUndeliveredSpecScreen> createState() =>
      _FinalUndeliveredSpecScreenState();
}

class _FinalUndeliveredSpecScreenState
    extends State<FinalUndeliveredSpecScreen> {
  @override
  void initState() {
    super.initState();
    debugPrint(
