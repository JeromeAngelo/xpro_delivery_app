...
class FinalCollectionScreen extends StatefulWidget {
  const FinalCollectionScreen({super.key});

  @override
  State<FinalCollectionScreen> createState() =>
      _FinalCollectionScreenState();
}

class _FinalCollectionScreenState extends State<FinalCollectionScreen>
