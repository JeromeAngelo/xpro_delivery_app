...
abstract class CollectionRemoteBase {
  ...
  CollectionModel processCollectionRecord(RecordModel record) {
    ...
    final collection = CollectionModel(
      ...
      transactionNumber: record.data['transactionNumber']?.toString(),
      chequeRefNumber: record.data['chequeRefNumber']?.toString(),
      bankAccountNumber: record.data['bankAccountNumber']?.toString(),
      bankName: record.data['bankName']?.toString(),
      refNumber: record.data['refNumber']?.toString(),
