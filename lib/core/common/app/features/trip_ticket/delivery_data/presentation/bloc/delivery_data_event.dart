...
/// 🔹 Watch local delivery data changes by Trip ID
class WatchLocalDeliveryDataByTripIdEvent extends DeliveryDataEvent {
  final String tripId;

  const WatchLocalDeliveryDataByTripIdEvent(this.tripId);
...
/// Event to get all delivery data
class WatchAllDeliveryDataEvent extends DeliveryDataEvent {
  const WatchAllDeliveryDataEvent();
}

class WatchLocalDeliveryDataByIdEvent extends DeliveryDataEvent {
  final String deliveryId;

  const WatchLocalDeliveryDataByIdEvent(this.deliveryId);
