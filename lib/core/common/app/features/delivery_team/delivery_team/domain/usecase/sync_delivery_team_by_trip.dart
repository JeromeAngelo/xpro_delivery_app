...
class SyncDeliveryTeamByTrip extends UsecaseWithParams<DeliveryTeamEntity, String> {
  const SyncDeliveryTeamByTrip(this._repo);

  final DeliveryTeamRepo _repo;

  @override
  ResultFuture<DeliveryTeamEntity> call(String params) => _repo.syncDeliveryTeamByTrip(params);
