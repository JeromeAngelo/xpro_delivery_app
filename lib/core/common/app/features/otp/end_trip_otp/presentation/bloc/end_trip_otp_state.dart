...
class EndTripOtpOdoStatusUpdated extends EndTripOtpState {
  final String id;
  final bool noOdometer;

  EndTripOtpOdoStatusUpdated({required this.id, required this.noOdometer});
...
class EndTripOtpLoaded extends EndTripOtpState {
  ...
  EndTripOtpLoaded({required this.generatedOtp, this.otpId, this.tripId});
