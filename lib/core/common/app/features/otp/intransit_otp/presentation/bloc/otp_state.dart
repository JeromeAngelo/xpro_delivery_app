...
class OtpOdoStatusUpdated extends OtpState {
  final String id;
  final bool noOdometer;

  OtpOdoStatusUpdated({required this.id, required this.noOdometer});
...
class OtpLoaded extends OtpState {
  ...
  OtpLoaded({required this.generatedOtp, this.otpId, this.tripId});
