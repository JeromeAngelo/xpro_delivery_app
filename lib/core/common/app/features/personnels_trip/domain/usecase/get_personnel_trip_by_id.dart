...
class GetPersonnelTripById extends UsecaseWithParams<PersonnelTripEntity, String> {
  const GetPersonnelTripById(this._repository);

  final PersonnelTripRepo _repository;

  @override
  ResultFuture<PersonnelTripEntity> call(String params) async =>
      _repository.getPersonnelTripById(params);
}
