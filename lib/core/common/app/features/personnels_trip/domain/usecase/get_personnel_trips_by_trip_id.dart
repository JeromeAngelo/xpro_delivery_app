...
class GetPersonnelTripsByTripId extends UsecaseWithParams<List<PersonnelTripEntity>, String> {
  const GetPersonnelTripsByTripId(this._repository);

  final PersonnelTripRepo _repository;

  @override
  ResultFuture<List<PersonnelTripEntity>> call(String params) async =>
      _repository.getPersonnelTripsByTripId(params);
}
