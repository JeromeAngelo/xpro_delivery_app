...
class LoadUpdateTimeline extends UsecaseWithoutParams<UpdateTimelineEntity> {
  const LoadUpdateTimeline(this._repo);

  final UpdateTimelineRepo _repo;

  @override
  ResultFuture<UpdateTimelineEntity> call() => _repo.loadUpdateTimeline();
}