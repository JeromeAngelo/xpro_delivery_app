...
class LoadUndeliverableCustomers extends UsecaseWithParams<List<UndeliverableCustomerEntity>, String> {
  const LoadUndeliverableCustomers(this._repo);

  final UndeliverableRepo _repo;

  @override
  ResultFuture<List<UndeliverableCustomerEntity>> call(String tripId) {
    return _repo.loadLocalUndeliverableCustomers(tripId);
  }
}